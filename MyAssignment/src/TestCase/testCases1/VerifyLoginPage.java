...
import utilityPackage.DataDrivenUtilities;

public class VerifyLoginPage extends CommonFunctions {
	int i = 1;
	static String paths = "C:\\Users\\VIKASA\\eclipse-workspace\\MyAssignment\\Login.xls";
	...
	public void Login(String username, String Password) throws IOException {
		...
		if (driver.findElements(By.linkText("Buildings")).size() != 0) {
			DataDrivenUtilities.setCellData("Sheet1", "Status", i, "Pass", paths);
			i = i + 1;
		} else {
			DataDrivenUtilities.setCellData("Sheet1", "Status", i, "Fail", paths);
			i = i + 1;
		}
	}
